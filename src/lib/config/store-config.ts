...
export const getStoreConfigSafe = (): StoreConfig => {
	...
	const storeName = storeConfig?.storeName || defaultConfig.storeName || BRAND.name;

	return {
		storeName,
		storeDescription: storeConfig?.storeDescription || defaultConfig.storeDescription || BRAND.tagline,
		storeDomain: storeConfig?.storeDomain || defaultConfig.storeDomain || BRAND.domain,
		...
		contact: storeConfig?.contact || {
			supportEmail: CONTACT.email.support,
			salesEmail: CONTACT.email.sales,
		...
		foundingDate: storeConfig?.foundingDate || BRAND.foundingYear,
		slogan: storeConfig?.slogan || BRAND.slogan,
